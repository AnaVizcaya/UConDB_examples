...
def run(args):
    ...
    '''
    table = "neardet2x2.pedestal_test" #Name of table in db schema_name.table_name
    ...
    # put data
    data = [0,22736.0, 1698716333.2174063 ]
    columns = ['channel', 'tv', 'upload_time' ]
    db.put_data(table, data, columns)
    return
